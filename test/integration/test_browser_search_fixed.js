...
console.log('\nRunning search tests with various queries...');
...
const multiTermResults = performSearch('javascript handlebars', mockSearchData);
...
console.log('✓ Handles various search terms correctly');
