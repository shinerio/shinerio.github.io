# Title Search Capability Specification

## Purpose

This specification defines the title search capabilities for the Obsidian blog generator. The title search functionality enables users to search specifically through article titles to find relevant articles with higher relevance scoring for title matches.
