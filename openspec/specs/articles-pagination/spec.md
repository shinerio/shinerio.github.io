...
Pagination SHALL integrate with the existing tag filter and sort controls. When a filter or sort option changes, the page number SHALL reset to 1 and the filtered/sorted results SHALL be re-paginated.
