# Search Coordinator Capability Specification

## Purpose

This specification defines the search coordinator capabilities for the Obsidian blog generator. The search coordinator functionality enables coordination between separate search engines (title and content) while maintaining backward compatibility with existing search interfaces.
